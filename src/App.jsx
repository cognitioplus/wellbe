    ...
    <div className="font-[Roboto_Condensed]">
      ...
      <section className="bg-gradient-to-br from-purple-900 to-pink-800 text-white text-center py-16 px-6">
        ...
        <button 
          ...
          className="bg-[#b425aa] hover:bg-[#b425aa]/90 font-[Montserrat] font-semibold px-8 py-3 rounded-md pulse"
        >
          Start Your Journey
        </button>
      </section>
      ...
      {activeTab === 'tracker' && (
        <section className="py-12 px-6 max-w-6xl mx-auto">
          <h2 className="text-3xl font-semibold mb-8 text-center text-white">Your Wellness Dashboard</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 mb-8">
            <div className="bg-white p-6 rounded-lg shadow">
              <h3 className="font-[Oswald] text-[#c80ec9]">HRV Score</h3>
              <div className="w-full bg-gray-200 rounded-full h-2.5 mt-2">
                <div className="bg-[#b425aa] h-2.5 rounded-full" style={{ width: '68%' }}></div>
              </div>
              <p className="mt-2 text-2xl font-bold">68</p>
              <p className="text-xs text-gray-500">Great recovery</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-xs text-gray-500">Deep sleep improved</p>
            </div>
            ...
            <div className="bg-white p-6 rounded-lg shadow">
              ...
              <p className="text-xs text-gray-500">Recharge with rest</p>
            </div>
          </div>
        </section>
      )}
      ...
      <footer className="text-center py-8 text-gray-200 text-sm">
        <p>© {new Date().getFullYear()} Cognitio+. Your Partner in Resilience. Rooted in Culture. Powered by Awareness. Enhanced by Technology. </p>
      </footer>
    </div>
  );
